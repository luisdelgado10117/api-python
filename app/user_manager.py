"""
Capa de lógica de negocio: UserManager.

Misma idea que TaskManager: encapsula las reglas de negocio (registrar,
autenticar) separadas de las rutas de Flask.
"""
...
class UserManager:
    ...
    def login(self, username, password) -> str:
        ...
        # Ojo: comparamos con el MISMO mensaje de error tanto si el usuario
        # no existe como si la contraseña está mal. Esto es a propósito:
        # así no le damos pistas a alguien que intenta adivinar cuentas.
